...
export const focusNames = {iteration:'Iteration',selection:'Selection'};
...
export function resolve(input) {
  ...
  if(fields.type===0&&questions.length!==(questions[0].setSize??1)) throw Error('Open one substantial puzzle at a time.');
